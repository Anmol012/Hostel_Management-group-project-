...
if (empty($regno)) {
    // Handle the case when $_SESSION['regno'] is not set
    echo "Session variable 'regno' is not set.";
...
$sql = "SELECT name, block, roomno FROM users WHERE regno=?";
...
if ($row = $result->fetch_assoc()) {
    ...
    // Handle the case when no user is found for the given regno
    echo "No user found for the specified registration number.";
    // You might want to redirect the user or display an error message
    exit();
}
