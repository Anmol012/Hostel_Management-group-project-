...
<div class="Nav" id="Nav1">
  <div class="NavbarContainer">
    <img src="images\nitjsr.png" alt="" class="NavLogo" onclick="rtohome()">
...
<div class="HeroContainer">
  ...
  <source src="videos\tour.mp4" type="video/mp4">
</video>
  </div>
<div class="HeroContent">
  <h1 class="HeroH1">Hostel Management System</h1>
  <p class="HeroP">NIT Jamshedpur</p>
...
<div class="FooterWrap">
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      ...
      <p class="WebsiteRights">NIT Jamshedpur © 2023</p>
      <div class="SocialIcons">
        <a href="https://www.facebook.com/NITJamshedpurOfficial/" class="SocialIconLink"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
        <a href="https://twitter.com/jamshedpur_nit?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" class="SocialIconLink"><i class="fa fa-twitter" aria-hidden="true"></i></a>
        <a href="https://www.instagram.com/nitjamshedpur_official/" class="SocialIconLink"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        <a href="https://www.youtube.com/" class="SocialIconLink"><i class="fa-brands fa-youtube"></i></a>
      </div>
    </div>
